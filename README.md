...
![Build](https://github.com/NHSDigital/elective-waiting-list/workflows/Build/badge.svg?branch=master)

This is a specification for the *elective-waiting-list* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/elective-waiting-list/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/elective-waiting-list/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `elective-waiting-list-target`.
